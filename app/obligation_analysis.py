...
from .schemas import AnalyzedObligation, ApprovedExecutionPlan, ManagerDecision
...
def analyze_obligation(obligation: str) -> AnalyzedObligation:
...
def build_execution_plan(
    ...
    max_proof = int(limits.get("max_proof_obligations_per_step", 1))
    max_evidence = int(limits.get("max_evidence_jobs_per_step", 2))

    analyzed = [analyze_obligation(ob) for ob in decision.formal_obligations]
    ...
    return ApprovedExecutionPlan(
        original_obligations=list(decision.formal_obligations),
