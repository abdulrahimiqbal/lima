...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    @app.post("/api/campaigns/{campaign_id}/world-evolution/pressure-height-scc-drift-wave")
    ...
    @app.post("/api/campaigns/{campaign_id}/world-evolution/pressure-height-final-closure-wave")
    def run_pressure_height_final_closure_wave(
        ...
        try:
            return service.run_pressure_height_final_closure_wave(campaign_id, payload)
        except KeyError as exc:
            raise HTTPException(status_code=404, detail=str(exc)) from exc
