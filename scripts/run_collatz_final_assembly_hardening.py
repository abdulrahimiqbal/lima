...
LEAN_PATH = ROOT / "researcherreview" / "ProCollatzFinal.lean"
...
def build_payload() -> dict[str, object]:
    ...
    return {
        "verdict": "collatz_final_assembly_hardening",
        "theorem_names": [
        ...
        "lean_check": run_lean("collatz_final_assembly_hardening", source),
    }
